...
Constraints
	...
	1 ≤ N ≤ 1000
	1 ≤ K ≤ N
 −100 ≤ ai ≤ 100, where i with in [1,N]

Note 
If a student arrives exactly on time (ai=0)(ai=0), the student is considered to have entered 
...
For the first test case, K=3. The professor wants at least 33 students in attendance, but 
only 22 have arrived on time (−3 and −1). Thus, the class is canceled.

For the second test case, K=2. The professor wants at least 22 students in attendance, and 
there are 22 who have arrived on time (0 and −1). Thus, the class is not canceled. */
...
int main(){
    ...
    for(int t = 0; t < numTestCases; t++){
        int numStudents, minStudents;
        cin >> numStudents >> minStudents;
        ...
        if(studentsPresent >= minStudents){
        	cout << "NO" << endl;
        }
        else{
        	cout << "YES" << endl;
